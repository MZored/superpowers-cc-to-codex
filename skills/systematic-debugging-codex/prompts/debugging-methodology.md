...
Detailed methodology for Phases 1-3 of systematic debugging.
This file is referenced by the investigation brief — Codex receives this when dispatched via `codex_debug`.
...
3. **Verify Before Continuing**
   - Did it work? Yes: proceed to fix recommendation
